...
String text_case_id_03 = "TC-001.03 quote validation";
String text_case_id_04 = "TC-001.04";
String text_case_id_05 = "TC-001.05";
String text_case_id_06 = "TC-001.06 label validation for all Main Page fields";
...
String fname = "Dmitry";
String lname = "Nakhabtsev";
String email = "dima@gmail.com";
String phone = "315 459-1970";
...
String compilation_type="debug"; // values for switch: run debug
...
case "debug":
	...
	driver.findElement(By.id("package-origin")).sendKeys("SFO"); // //*[@id="package-origin"]
	driver.findElement(By.id("package-destination")).sendKeys("Dmitry"); // //*[@id="package-destination"]
	driver.findElement(By.id("package-departing")).click(); //    //*[@id="package-departing"]  
	Thread.sleep(1000);
	driver.findElement(By.xpath(".//*[@id='package-departing-wrapper']/div/div/div[2]/table/tbody/tr[4]/td[5]/button")).click(); //  .//*[@id='package-departing-wrapper']/div/div/div[2]/table/tbody/tr[4]/td[5]/button
...
System.out.println("Test Case ID: \t\t" + text_case_id_46 + " - PASSED");
